    ...
    },
{
  ...
  exec: async () => {
    ...
    // Disable Arrow compression with output_format_arrow_compression_method
  ...
  exec: async () => {
    ...
    exec: async () => {
      ...
      // Try reading as a stream instead of file format
      const reader = arrow.RecordBatchStreamReader.from(execResult.stream);
      const batches = [];
